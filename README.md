...
This is the root directory of the repository. The directory is structured as follows:
    ...
    Replication package of STARLA
     ...
     |
     |---------- SMARLA_HighwayDriving_Frequency.ipynb         Implementation of the SMARLA on Highway Driving problem using frequency-based features
     |
     |---------- RQ_Highway_Driving_Frequency.ipynb             Codes to replicate RQ1 - RQ2 - RQ3 and RQ4 using frequency features   
     |
     |      
...
Note that we also present the findings of our study on the Highway case study relying on the features based on the frequncy of abstract states visited during each episode.
...
<p align="center" width="100%">
   <img width="45%" alt="Highway" src="Results/Highway-Driving/RQ1.png">
 </p>
 <p align="center" width="50%">
...
<p align="center" width="100%">
   <img width="45%" alt="Highway_f" src="Results/Highway-Driving/RQ1_f.png">
 </p>
 <p align="center" width="50%">
   Performance of the safety violation prediction model in Highway Driving using frequency-based features
</p>
...
<p align="center" width="100%">
   <img width="45%" alt="Highway" src="Results/Highway-Driving/RQ2.png">
 </p>
 <p align="center" width="50%">
...
<p align="center" width="100%">
   <img width="45%" alt="Highway_f" src="Results/Highway-Driving/RQ2_f.png">
 </p>
 <p align="center" width="50%">
   F1-score of the safety violation prediction model for different decision criteria in the Highway Driving case study using frequency-based features
</p>
...
<p align="center" width="50%">
   Comparison of 25%, 50%, and 75% threshold values for Mountain-Car, Cart-Pole, Highway Driving using binary features (Highway Driving), and Highway Driving using frequency-based features (Highway Driving*)
</p>
...
<p align="center" width="100%">
    <img width="50%" src="Results/Highway-Driving/F_RQ4.png" > 
</p>
<p align="center" width="50%">
   Cart-Pole case study
</p>
...
<p align="center" width="100%">
    <img width="45%" src="Results/Highway-Driving/F_RQ3.png"> 
</p>
